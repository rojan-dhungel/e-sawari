...
const Footer = () => {
  return (
    <footer className="bg-[#2C3340] text-white px-6 py-16 md:px-12 lg:px-16 font-body">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm md:text-base">
              {[
                ...
                // { label: "Vehicle Rentals", href: "/services/vehicle-rentals" },
                {label: "Hotel Booking", href: "/services/hotel-booking" },
                // { label: "Helicopter Services", href: "/services/helicopter-services" },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-11 h-11 rounded-full bg-primary-green flex items-center justify-center hover:bg-green-700 transition-colors"
                aria-label="WhatsApp"
              >
