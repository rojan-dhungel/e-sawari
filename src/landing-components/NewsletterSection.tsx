...
const NewsletterSection = () => {
  ...
  return (
    <section className="px-8 py-20 md:px-8 bg-roads">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl font-bold font-heading text-light leading-[1.2] tracking-tighter">
            Never Miss a Deal!
          </h3>
          <p className="mb-8 text-base md:text-lg max-w-2xl mx-auto font-body font-light leading-relaxed text-light/80">
          ...
          {!isSubscribed ? (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-3 bg-white font-bold rounded-2xl text-primary-green hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 flex items-center justify-center font-body"
              >
                {isLoading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
