      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs font-semibold mb-2 text-paragraph">
              Demo Credentials:
            </p>
            <div className="bg-light rounded p-3 text-xs space-y-1 font-menlo">
              <p className="text-paragraph">
                <span className="text-paragraph">Email:</span> {ADMIN_EMAIL}
              </p>
              <p className="text-paragraph">
                <span className="text-paragraph">Password:</span> {ADMIN_PASSWORD}
              </p>
            </div>
          </div>
        </div>
